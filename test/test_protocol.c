...
void test_unsubscribeFromStatus(void) {
    ...
    communicationEndpointPublishRaw((posting_t){
        .topic = "eip://uni-due.de/es/remote/"STATUS, .data = "testUnsubStatus0"});
    TEST_ASSERT_EQUAL_STRING("testUnsubStatus0", lastDelivered.data);

    protocolUnsubscribeFromStatus(remoteTwin, subscriber);
    communicationEndpointPublishRaw((posting_t){
        .topic = "eip://uni-due.de/es/remote/"STATUS, .data = "testUnsubStatus1"});
    // Should not have changed as Subscriber is now longer subscribed too topic
    TEST_ASSERT_EQUAL_STRING("testUnsubStatus0", lastDelivered.data);
}

void test_publishCommand(void) {
    communicationEndpointSubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubCmd0", subscriber);
    communicationEndpointSubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubCmd1", subscriber);
    ...
    communicationEndpointUnsubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubCmd0", subscriber);
    communicationEndpointUnsubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubCmd1", subscriber);
}

void test_publishOnCommand(void) {
    communicationEndpointSubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubOn0", subscriber);

    protocolPublishOnCommand("remote", "testPubOn0");
    TEST_ASSERT_EQUAL_STRING("1", lastDelivered.data);

    communicationEndpointUnsubscribe("eip://uni-due.de/es/remote/"COMMAND"/testPubOn0", subscriber);
}

void test_publishOffCommand(void) {
    communicationEndpointSubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubOff0", subscriber);

    protocolPublishOffCommand("remote", "testPubOff0");
    TEST_ASSERT_EQUAL_STRING("0", lastDelivered.data);

    communicationEndpointUnsubscribeRaw("eip://uni-due.de/es/remote/"COMMAND"/testPubOff0", subscriber);
}
...
void test_subscribeForCommand(void) {
    ...
    communicationEndpointPublishRaw(
        (posting_t){.topic = "eip://uni-due.de/es/self/"COMMAND"/testCommand0", .data = "testData0"});
    TEST_ASSERT_EQUAL_STRING("testData0", lastDelivered.data);

    communicationEndpointPublishRaw(
        (posting_t){.topic = "eip://uni-due.de/es/self/"COMMAND"/testCommand1", .data = "testData1"});
    TEST_ASSERT_EQUAL_STRING("testData1", lastDelivered.data);
